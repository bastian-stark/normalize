...
# Bastian Stark
# May 31, 2024
# Short script for normalizing the counts of each hexamer in given BED file to genomic hexamer counts.

#function for reverse complementing input sequence
def revComp(seq):
...
normalizedCounts = {}
#normalizes counts from BED file to counts from genomic counts by dividing BED counts by genomic counts
